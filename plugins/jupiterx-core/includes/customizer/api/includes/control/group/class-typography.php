...
class JupiterX_Customizer_Group_Control_Typography extends JupiterX_Customizer_Base_Group_Control {
	...
	protected function set_fields() {
		$this->add_field( 'font_family', [
			'type'        => 'jupiterx-font',
			'alt'         => __( 'Font Family', 'jupiterx-core' ),
			'column'      => '5',
			'icon'        => 'font-family',
		...
		$this->add_field( 'font_weight', [
			...
			'icon'        => 'font-weight',
			'exclude_reload' => true,
			'alt'         => __( 'Font Weight', 'jupiterx-core' ),
			'placeholder' => __( 'Default', 'jupiterx-core' ),
		...
		$this->add_field( 'line_height', [
			...
			'column'      => '4',
			'icon'        => 'line-height',
			'alt'         => __( 'Line Height', 'jupiterx-core' ),
			'units'       => [ '-', 'px', 'em', 'rem' ],
			'defaultUnit' => '-',
		] );
		...
		$this->add_field( 'letter_spacing', [
			...
			'column'      => '4',
			'icon'        => 'letter-spacing',
			'alt'         => __( 'Letter Spacing', 'jupiterx-core' ),
			'inputAttrs'  => [
				'min' => -1000,
			],
			'units'       => [ 'px', 'em', 'rem' ],
		...
		$this->add_field( 'text_transform', [
			...
			'column'      => '5',
			'icon'        => 'text-transform',
			'alt'         => __( 'Text transform', 'jupiterx-core' ),
			'placeholder' => __( 'Default', 'jupiterx-core' ),
			'choices'     => [

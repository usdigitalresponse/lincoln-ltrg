...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'jupiterx-core' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'jupiterx-core' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'jupiterx-core' ),
			'200'       => esc_attr__( 'Light 200', 'jupiterx-core' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'jupiterx-core' ),
			'300'       => esc_attr__( 'Book 300', 'jupiterx-core' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'jupiterx-core' ),
			'400'       => esc_attr__( 'Normal 400', 'jupiterx-core' ),
			'regular'   => esc_attr__( 'Normal 400', 'jupiterx-core' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'jupiterx-core' ),
			'500'       => esc_attr__( 'Medium 500', 'jupiterx-core' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'jupiterx-core' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'jupiterx-core' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'jupiterx-core' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'jupiterx-core' ),
			'700'       => esc_attr__( 'Bold 700', 'jupiterx-core' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'jupiterx-core' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'jupiterx-core' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'jupiterx-core' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'jupiterx-core' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'jupiterx-core' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'jupiterx-core' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'jupiterx-core' ),
		);
	}
